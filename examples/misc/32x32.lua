...
source: https://github.com/raysan5/raylib/blob/master/examples/misc/misc_32x32.c
...
while not rl.WindowShouldClose() do
  ...
  rl.DrawTextEx(rl.GetFontDefault(), "Hello", rl.rlVertex2f(4, 0), rl.GetFontDefault().baseSize, 1,
    rl.new("Color", 0, 64, 255, 255))
  rl.DrawTextEx(rl.GetFontDefault(), "it's", rl.rlVertex2f(8, 10), rl.GetFontDefault().baseSize, 1,
    rl.new("Color", 0, 64, 255, 255))
  rl.DrawTextEx(rl.GetFontDefault(), "raylua", rl.rlVertex2f(0, 20), rl.GetFontDefault().baseSize, 1,
    rl.new("Color", 0, 64, 255, 255))
