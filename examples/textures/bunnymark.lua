...
source: https://github.com/raysan5/raylib/blob/master/examples/textures/textures_bunnymark.c
  ...
  if rl.IsMouseButtonDown(rl.MOUSE_BUTTON_LEFT) then
    ...
    for i = 1, 100 do
      if #bunnies < MAX_BUNNIES then
        local speed = rl.rlVertex2f(rl.GetRandomValue(-250, 250) / 60, rl.GetRandomValue(-250, 250) / 60)
        local color = rl.new("Color", rl.GetRandomValue(50, 240), rl.GetRandomValue(80, 240), rl.GetRandomValue(100, 240),
          255)
