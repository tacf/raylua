...
source: https://github.com/raysan5/raylib/blob/master/examples/shaders/shaders_postprocessing.c
...
local screenSize = rl.rlVertex2f(screenWidth, screenHeight)

local fbWidth = screenWidth / ratio
local fbHeight = screenHeight / ratio

local fbSize = rl.rlVertex2f(fbWidth, fbHeight)
...
while not rl.WindowShouldClose() do
  ...
  if preset_changed then
    ...
    fbSize = rl.rlVertex2f(fbWidth, fbHeight)
