return {
  defines = {
    ...
    },
    {
      ...
      type = "GUARD",
      value = "",
      description = "Disable unsafe warnings on scanf() functions in MSVC"
    },
    {
    ...
    {
      name = "GUI_BUTTON_DOWN",
      type = "UNKNOWN",
      value = "(IsMouseButtonDown(MOUSE_LEFT_BUTTON) || IsGamepadButtonDown(0, GAMEPAD_BUTTON_RIGHT_FACE_DOWN))",
      description = ""
    },
    {
      name = "GUI_BUTTON_DOWN_ALT",
      type = "UNKNOWN",
      value = "(IsMouseButtonDown(MOUSE_RIGHT_BUTTON) || IsGamepadButtonDown(0, GAMEPAD_BUTTON_RIGHT_FACE_RIGHT))",
      description = ""
    },
    {
      name = "GUI_BUTTON_PRESSED",
      type = "UNKNOWN",
      value = "(IsMouseButtonPressed(MOUSE_LEFT_BUTTON) || IsGamepadButtonPressed(0, GAMEPAD_BUTTON_RIGHT_FACE_DOWN))",
      description = ""
    },
    {
    ...
    {
      name = "GUI_SCROLL_DELTA",
      type = "UNKNOWN",
      value = "((float)IsGamepadButtonDown(0, GAMEPAD_BUTTON_RIGHT_TRIGGER_2) - (float)IsGamepadButtonDown(0, GAMEPAD_BUTTON_LEFT_TRIGGER_2))",
      description = ""
    },
    {
      name = "GUI_POINTER_POSITION",
      type = "UNKNOWN",
      value = "GetMousePosition()",
      description = ""
    },
    {
      name = "GUI_KEY_DOWN(key)",
      type = "MACRO",
      value = "IsKeyDown(key)",
      description = ""
    },
    {
      name = "GUI_KEY_PRESSED(key)",
      type = "MACRO",
      value = "IsKeyPressed(key)",
      description = ""
    },
    {
      name = "GUI_INPUT_KEY",
    ...
    },
    {
      ...
      type = "MACRO",
      value = "(((int)src.x == (int)dst.x) && ((int)src.y == (int)dst.y) && ((int)src.width == (int)dst.width) && ((int)src.height == (int)dst.height))",
      description = ""
    },
    {
    ...
    {
      name = "RAYGUI_WINDOWBOX_CLOSEBUTTON_HEIGHT",
      type = "INT",
      value = 18,
      description = ""
    },
  ...
  enums = {
    ...
    {
      name = "GuiValueBoxProperty",
      description = "ValueBox/Spinner",
      values = {
        {
          name = "SPINNER_BUTTON_WIDTH",
          value = 16,
          description = "Spinner left/right buttons width"
        },
        {
          name = "SPINNER_BUTTON_SPACING",
          value = 17,
    ...
    },
    {
      ...
      values = {
        ...
        },
        {
          ...
          value = 20,
          description = "ListView items border enabled in normal state"
        },
        {
    ...
    },
    {
      ...
      values = {
        ...
        {
          name = "ICON_CIRCLE_ADD",
          value = 234,
          description = ""
        },
        {
          name = "ICON_CIRCLE_ADD_FILL",
          value = 235,
          description = ""
        },
        {
          name = "ICON_CIRCLE_WARNING",
          value = 236,
          description = ""
        },
        {
          name = "ICON_CIRCLE_WARNING_FILL",
          value = 237,
          description = ""
        },
        {
        ...
        {
          name = "ICON_INTERSECTION",
          value = 243,
          description = ""
        },
        {
          name = "ICON_DIFFERENCE",
          value = 244,
          description = ""
        },
        {
  ...
  functions = {
    ...
    {
      name = "GuiGetTextWidth",
      description = "Get text width considering gui style and icon size (if required)",
      returnType = "int",
      params = {
        {type = "const char *", name = "text"}
      }
