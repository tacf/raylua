return {
  defines = {
    ...
    },
    {
      name = "SW_CALLOC(n,sz)",
      type = "MACRO",
      value = "RL_CALLOC(n, sz)",
      description = ""
    },
    {
      name = "SW_REALLOC(ptr, newSz)",
      type = "MACRO",
      value = "RL_REALLOC(ptr, newSz)",
      description = ""
    },
    {
      name = "SW_FREE(ptr)",
    ...
    {
      name = "RL_DEFAULT_SHADER_ATTRIB_NAME_BONEINDICES",
      type = "STRING",
      value = "vertexBoneIndices",
      description = "Bound by default to shader location: RL_DEFAULT_SHADER_ATTRIB_LOCATION_BONEINDICES"
    },
    {
    ...
    },
    {
      ...
      description = "Bound by default to shader location: RL_DEFAULT_SHADER_ATTRIB_LOCATION_INSTANCETRANSFORM"
    },
    {
  ...
  structs = {
    ...
    },
    {
      ...
      fields = {
        ...
        },
        {
          ...
          description = "Current texture id to be used on glBegin"
        },
        {
          type = "unsigned int",
    ...
    },
    {
      ...
      fields = {
        {
          type = "static rl_float16 rlMatrixToFloatV(Matrix",
          name = "",
          description = ""
        },
        {
          type = "#define rlMatrixToFloat(mat) (rlMatrixToFloatV(mat).v)      // Gstatic ",
          name = "",
          description = ""
        },
        {
        ...
        {
          type = "static Matrix rlMatrixTranspose(Matrix",
          name = "",
          description = "//---------------------------------------"
        },
        {
          type = "static Matrix rlMatrixInvert(Matrix",
          name = "",
          description = ""
        },
        {
        ...
        {
          type = "#if defined(GRAPHICS_API_OPENGL_11)",
          name = "",
          description = ""
        },
        {
          type = "void rlMatrixMode(int mode)",
          name = "glMatrixMode(GL_PROJECTION)",
          description = ""
        },
        {
          type = "{",
        ...
        {
          type = "case RL_PROJECTION:",
          name = "glMatrixMode(GL_PROJECTION)",
          description = ""
        },
        {
          type = "case RL_MODELVIEW:",
          name = "glMatrixMode(GL_MODELVIEW)",
          description = ""
        },
        {
          type = "case RL_TEXTURE:",
          name = "glMatrixMode(GL_TEXTURE)",
          description = ""
        },
        {
          type = "default:",
